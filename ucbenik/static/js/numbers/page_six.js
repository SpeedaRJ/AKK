...
function redo(e) {
    ...
    if (c < 2)
        document.getElementById("solution").innerHTML = "chair."
    else
        document.getElementById("solution").innerHTML = "chairs."
    ...
    if (c < 2)
        document.getElementById("solution2").innerHTML = "dog."
    else
        document.getElementById("solution2").innerHTML = "dogs."
    document.getElementById("textarea2").value="";
}
