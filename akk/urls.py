...
urlpatterns = [
    ...
    path("lesson_one/numbers/page_seventeen", views.numbers_page_twentythree, name="numbers_page_twentythree"),
    path("lesson_one/numbers/page_eighteen", views.numbers_page_twentyfour, name="numbers_page_twentyfour"),
    path("lesson_one/numbers/page_nineteen", views.numbers_page_twentyfive, name="numbers_page_twentyfive"),
    path("lesson_one/numbers/page_twenty", views.numbers_page_seventeen, name="numbers_page_seventeen"),
    path("lesson_one/numbers/page_twentyone", views.numbers_page_eighteen, name="numbers_page_eighteen"),
    path("lesson_one/numbers/page_twentytwo", views.numbers_page_nineteen, name="numbers_page_nineteen"),
    path("lesson_one/numbers/page_twentythree", views.numbers_page_twenty, name="numbers_page_twenty"),
    path("lesson_one/numbers/page_twentyfour", views.numbers_page_twentyone, name="numbers_page_twentyone"),
    path("lesson_one/numbers/page_twentyfive", views.numbers_page_twentytwo, name="numbers_page_twentytwo"),
    ...
    path("lesson_one/he_she_it/page_seventwo", views.he_she_it_page_seven2, name="he_she_it_page_seven"),
    ...
    path("lesson_two/occupations/page_one", views.occupations_page_one, name="daily_occupations_one"),
    ...
    path("lesson_three/pronouns/page_twelve", views.pronouns_page_twelve, name="pronouns_page_twelve"),
    path("lesson_three/pronouns/page_thirteen", views.pronouns_page_thirteen, name="pronouns_page_thirteen"),
    path("lesson_three/pronouns/page_fourteen", views.pronouns_page_fourteen, name="pronouns_page_fourteen"),
    path("lesson_three/pronouns/page_sixteen", views.pronouns_page_sixteen, name="pronouns_page_sixteen"),
    path("lesson_three/pronouns/page_seventeen", views.pronouns_page_seventeen, name="pronouns_page_seventeen"),
    path("lesson_three/pronouns/page_eighteen", views.pronouns_page_eighteen, name="pronouns_page_eighteen"),
    path("lesson_three/pronouns/page_nineteen", views.pronouns_page_nineteen, name="pronouns_page_nineteen"),
    path("lesson_three/pronouns/page_twenty", views.pronouns_page_twenty, name="pronouns_page_twenty"),
    path("lesson_three/pronouns/page_twentyone", views.pronouns_page_twentyone, name="pronouns_page_twentyone"),
    path("lesson_three/pronouns/page_twentytwo", views.pronouns_page_twentytwo, name="pronouns_page_twentytwo"),
    path("lesson_three/pronouns/page_twentythree", views.pronouns_page_twentythree, name="pronouns_page_twentythree"),
    path("lesson_three/pronouns/page_twentyfour", views.pronouns_page_twentyfour, name="pronouns_page_twentyfour"),
    path("lesson_three/pronouns/page_twentyfive", views.pronouns_page_twentyfive, name="pronouns_page_twentyfive"),
    path("lesson_three/pronouns/page_twentysix", views.pronouns_page_twentysix, name="pronouns_page_twentysix"),
    path("lesson_three/pronouns/page_twentyseven", views.pronouns_page_twentyseven, name="pronouns_page_twentyseven"),
    path("lesson_three/pronouns/page_twentyeight", views.pronouns_page_twentyeight, name="pronouns_page_twentyeight"),
    path("lesson_three/pronouns/page_twentynine", views.pronouns_page_twentynine, name="pronouns_page_twentynine"),
    path("lesson_three/pronouns/page_thirty", views.pronouns_page_thirty, name="pronouns_page_thirty"),
    path("lesson_three/pronouns/page_thirtyone", views.pronouns_page_thirtyone, name="pronouns_page_thirtyone"),
    path("lesson_three/pronouns/page_thirtytwo", views.pronouns_page_thirtytwo, name="pronouns_page_thirtytwo"),
    path("lesson_three/pronouns/page_thirtythree", views.pronouns_page_thirtythree, name="pronouns_page_thirtythree"),
    path("lesson_three/pronouns/page_thirtyfour", views.pronouns_page_thirtyfour, name="pronouns_page_thirtyfour"),
    path("lesson_three/pronouns/page_thirtyfive", views.pronouns_page_thirtyfive, name="pronouns_page_thirtyfive"),
    ...
    path("lesson_three/house/page_three", views.house_page_three, name="house_page_three"),
    ...
    path("lesson_three/house/page_seven", views.house_page_seven, name="house_page_seven"),
    path("lesson_three/house/page_eight", views.house_page_eight, name="house_page_eight"),
    path("lesson_three/house/page_nine", views.house_page_nine, name="house_page_nine"),
    path("lesson_three/house/page_ten", views.house_page_ten, name="house_page_ten"),
    path("lesson_three/house/page_eleven", views.house_page_eleven, name="house_page_eleven"),
    path("lesson_three/house/page_twelve", views.house_page_twelve, name="house_page_twelve"),
    path("lesson_three/house/page_thirteen", views.house_page_thirteen, name="house_page_thirteen"),
    path("lesson_three/house/page_fourteen", views.house_page_fourteen, name="house_page_fourteen"),
    path("lesson_three/house/page_fifteen", views.house_page_fifteen, name="house_page_fifteen"),
    path("lesson_three/house/page_sixteen", views.house_page_sixteen, name="house_page_sixteen"),
    path("lesson_three/house/page_seventeen", views.house_page_seventeen, name="house_page_seventeen"),
    path("lesson_three/house/page_eighteen", views.house_page_eighteen, name="house_page_eighteen"),
    ...
    path("lesson_three/market/page_two", views.market_page_two, name="market_page_two"),
    path("lesson_three/market/page_three", views.market_page_three, name="market_page_three"),
    path("lesson_three/market/page_four", views.market_page_four, name="market_page_four"),
    path("lesson_three/market/page_five", views.market_page_five, name="market_page_five"),
    path("lesson_three/market/page_six", views.market_page_six, name="market_page_six"),
    path("lesson_three/market/page_seven", views.market_page_seven, name="market_page_seven"),
    path("lesson_three/market/page_eight", views.market_page_eight, name="market_page_eight"),
