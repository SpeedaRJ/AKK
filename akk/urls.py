...
urlpatterns = [
    ...
    path("lesson_two/occupations/page_one", views.occupations_one, name="daily_occupations_one"),
    path("lesson_two/occupations/page_two", views.occupations_two, name="daily_occupations_two"),
    path("lesson_two/occupations/page_three", views.occupations_three, name="daily_occupations_three"),
    path("lesson_two/occupations/page_four", views.occupations_four, name="daily_occupations_four"),
    path("lesson_two/occupations/page_five", views.occupations_five, name="daily_occupations_five"),
    path("lesson_two/occupations/page_six", views.occupations_six, name="daily_occupations_six"),
    path("lesson_two/occupations/page_seven", views.occupations_seven, name="daily_occupations_seven"),
    path("lesson_two/occupations/page_eight", views.occupations_eight, name="daily_occupations_eight"),
    # Lesson3
